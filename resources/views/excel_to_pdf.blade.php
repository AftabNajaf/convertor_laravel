...
@section('title','Convert Excel to PDF. Documents & tables XLS to PDF')
@section('content')
    <div class="main">
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__header">
                    <h1 class="tool__header__title">Convert EXCEL to PDF</h1>
                    <h2 class="tool__header__subtitle">Make EXCEL spreadsheets easy to read by converting them to PDF.
                    </h2>
                </div>
                ...
                <div id="uploader" class="uploader">
                    ...
                    <div class="uploader__extra">
                        ...
                        <a id="gdrive_file_selector" class="btn-icon uploader__extra__btn tooltip tooltip--right active"
                           title="Select EXCEL from Google Drive">
                        ...
                        <a id="dropbox_file_selector"
                           ...
                           title="Select EXCEL from Dropbox">
                    ...
                    <div class="uploader__droptxt">or drop EXCEL spreadsheets here</div>
                </div>
                <div id="ad" class="add">
            ...
            <div id="sidebar" class="tool__sidebar">
                <div class="option__panel option__panel--active" id="merge-options">
                    <div class="option__panel__title">Excel to PDF</div>
        ...
        <div id="process" class="process">
            <p id="processText" class="processAction title2">Converting EXCEL to PDF...</p>
    ...
    <script>
        var siteData = {
            ...
            csrfToken: 'jOdnTvnDGzZStewkqINBQ5xjTvjY74bDWffkILfj9zPDsT06vbosA2bBwWjN9zcZqykprIm-04Ecn65257OvRA=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
