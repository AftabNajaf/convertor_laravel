...
@section('title','Add page numbers to a PDF file online')
@section('content')
    <div class="main">
        ...
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__header">
                    <h1 class="tool__header__title">Add PDF page numbers</h1>
                    <h2 class="tool__header__subtitle">Add page numbers into PDFs with ease. Choose your positions,
                        dimensions, typography.</h2>
                </div>
                ...
                <div id="ad" class="add">
                    <div id='div-gpt-ad-1662466822732-0' class="in_add">
                        <script>
                            googletag.cmd.push(function () { googletag.display('div-gpt-ad-1662466822732-0') });
                        </script>
                    </div>
                </div>
                ...
                <div class="tool__workarea__rendered" id="fileGroups">
                    <div class="tool__workarea__info">Page numbers will be applied to these files</div>
                </div>
            </div>
            <div id="sidebar" class="tool__sidebar">
                <div class="option__panel option__panel--active" id="panel-options" data-process="yes">
                    <div class="option__panel__title">Page Number options</div>
                    <div class="options">
                        <div class="option__panel__content">
                            <div class="form__group" style=" margin-top: 4px;">
                                <p class="option__title">Page mode</p>
                                <div class="form__group radio-list">
                                    <div class="radio-list">
                                        <div class="radio">
                                            <input type="radio" name="facing_pages" id="facing_pages_single"
                                                   value="false" class="radio option">
                                            <label for="facing_pages_single">Single page</label>
                                        </div>
                                        <div class="radio">
                                            <input type="radio" name="facing_pages" id="facing_pages_facing"
                                                   value="true" class="radio option">
                                            <label for="facing_pages_facing">Facing pages</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form__group checkbox coverOption" data-if="facing_pages" data-value="true">
                                    <input type="checkbox" name="first_cover" class="checkbox option" id="first_cover">
                                    <label for="first_cover">
                                        First page is cover page </label>
                                </div>
                            </div>
                        </div>
                        <div class="option__panel__content">
                            <div class="row">
                                    ...
                                    <div class="form__group">
                                        ...
                                        <div class="option__page">
                                            ...
                                            <div class="option__page__row">
                                                ...
                                                <div class="option__page__position" data-vertical="bottom"
                                                     data-horizontal="center"></div>
                                                <div class="option__page__position option--active"
                                                     data-vertical="bottom" data-horizontal="right"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form__group">
                                        <label class="option__title">Margin:</label>
                                        <select class="input" id="textFormat">
                                            <option value="small">Small</option>
                                            <option selected value="medium">Recommended</option>
                        ...
                        <div class="option__panel__content">
                            <p class="option__title">Pages</p>
                            <div class="form__group">
                                <div class="form__group form__group--boxed">
                                    <label>First number:</label>
                                    <input class="input option pagefrom" type="number" name="starting_number" value="1"
                                           placeholder="Type a number">
                                </div>
                            </div>
                            <br />
                            <div class="form__group multiple_pages single_file">
                            ...
                            <br />
                            <div class="form__group multiple_files">
                                <label>
                                    Which pages do you want to number? <div class="moreinfo tooltip"
                                                                            title="Options for multiple files">
                                ...
                                <div class="form__group__container">
                                    <div class="form__group">
                                        <select class="input" id="start_pages">
                                            <option selected value="0">All pages from the beginning</option>
                                            <option value="1">Start at page 1</option>
                                            <option value="1">Exclude the first page</option>
                                            <option value="2">Exclude the first 2 pages</option>
                                            <option value="3">Exclude the first 3 pages</option>
                                            <option value="4">Exclude the first 4 pages</option>
                                            <option value="5">Exclude the first 5 pages</option>
                                        </select>
                                    </div>
                                    <span style="margin:8px;"></span>
                                    <div class="form__group">
                                        <select class="input" id="end_pages">
                                            <option selected value="0">All pages to the end</option>
                                            <option value="1">Ends at 1 before last</option>
                                            <option value="1">Exclude the last page</option>
                                            <option value="2">Exclude the last 2 pages</option>
                                            <option value="3">Exclude the last 3 pages</option>
                                            <option value="4">Exclude the last 4 pages</option>
                                            <option value="5">Exclude the last 5 pages</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <!--<p class="multiple_files">All pages will be numbered because multiple PDF have been selected.</p>-->
                        </div>
                        <div class="option__panel__content">
                            <div class="form__group">
                                <label class="option__title">Text:</label>
                                <select class="input option" id="text" name="text" data-name="text">
                            ...
                            <div data-if="text" data-value="custom">
                                <div class="form__group">
                                    <div>
                                        <label for="textCustom">Custom text:</label>
                                        <input class="input" type="text" id="textCustom" name="textCustom"
                                               value="Page {n} of {p}">
                                    </div>
                                    <small>Text samples: {n}, Page {n}, Page {n} of {p}</small>

                                    <small class="hidden">Text samples: {n}, Page {n}, Page {n} of {p}, Page {n} of {r},
                                        Page {n} of {rf}</small>
                                    <small class="hidden">
                                        {n} current page number {p} total pages number {r} total pages in a range.
                                        Example: from 3 to 10, {r} is 7 {rf} total pages in a range counting from first
                                        number Example: from 3 to 10, {rf} is 13 </small>
                        ...
                        <div class="option__panel__content">
                            <p class="option__title">Text format:</p>
                                ...
                                <div class="editor__toolbar__block">
                                    <div class="editor__toolbar__option">
                                        <div class="editor__option__selector ">
                                            <div class="font-selected" data-country="ALL" style="font-family:'arial';">
                                                Arial</div>
                                        </div>
                                        <div class="editor__option__content">
                                            <div class="font-selector" style="font-family:'arial';" data-value="arial"
                                                 data-country="ALL" data-italic="true" data-bold="true">
                                                Arial </div>
                                            <div class="font-selector" style="font-family:'impact';" data-value="impact"
                                                 data-country="ALL" data-italic="false" data-bold="false">
                                                Impact </div>
                                            ...
                                            <div class="font-selector" style="font-family:'courier';"
                                                 ...
                                                 data-bold="true">
                                                Courier </div>
                                            <div class="font-selector" style="font-family:'comic';" data-value="comic"
                                                 data-country="ALL" data-italic="true" data-bold="true">
                                                Comic </div>
                                    ...
                                    <div class="editor__toolbar__option">
                                        <div class="editor__option__selector">
                                            <svg width="19px" height="14px" viewBox="0 0 19 14" version="1.1"
                                                 ...
                                                 xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <g transform="translate(-538.000000, -563.000000)" fill="#161616">
                                        ...
                                        <div class="editor__option__content">
                                            <div class="form__group form__group--inline-3">
                                                ...
                                                <input class="rangeInput" type="number" name="font_size_number"
                                                       id="textFormatOptionsFontSizeText" value="48" min="0" max="100" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="editor__toolbar__option">
                                        <div class="editor__option bold">
                                            <svg width="10px" height="12px" viewBox="0 0 10 12" version="1.1"
                                                 ...
                                                 xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <g transform="translate(-600.000000, -392.000000)" fill="#161616">
                                                        <path
                                    ...
                                    <div class="editor__toolbar__option">
                                        <div class="editor__option italic">
                                            <svg width="9px" height="12px" viewBox="0 0 9 12" version="1.1"
                                                 ...
                                                 xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <g transform="translate(-637.000000, -563.000000)" fill="#161616">
                                                        <polygon id="I-Copy-7"
                                    ...
                                    <div class="editor__toolbar__option">
                                        <div class="editor__option underline">
                                            <svg width="13px" height="14px" viewBox="0 0 13 14" version="1.1"
                                                 ...
                                                 xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <g transform="translate(-671.000000, -563.000000)" fill="#161616">
                                                        <path
                                    ...
                                    <div class="editor__toolbar__option toolbar-background">
                                        ...
                                        <div class="editor__option__content">
                                            <div class="row">
                                                <div class="col">
                                                    Background color
                                                    <input class="color no-picker" data-inline="true" data-limit="true"
                                                           data-empty="true" type="text" name="background"
                                                           value="transparent">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="editor__option__content">
                                            <div class="row">
                                                <div class="col">
                                                    Font color:
                                                    <input class="color no-picker" data-inline="true" data-limit="true"
                                                           type="text" name="font_color" value="#ffffff">
                                                </div>
                                                <div class="col toolbar-font-shadow">
                                                    Font shadow:
                                                    <input class="color no-picker" data-inline="true" data-limit="true"
                                                           type="text" name="font_color_shadow" data-empty="true"
                                                           value="#000000">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="editor__toolbar__option">
                                        <div class="editor__option__selector">
                                            <svg width="20px" height="17px" viewBox="0 0 20 17" version="1.1"
                                                 ...
                                                 xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <g transform="translate(-799.000000, -562.000000)" fill="#161616"
                                                       fill-rule="nonzero">
                                                        <path
                                                    ...
                                                    <g transform="translate(-798.000000, -391.000000)">
                                                        <g transform="translate(798.000000, 391.000000)">
                                                            <rect id="shape-copy-3" fill="#626870" x="6.66666667"
                                                                  y="6.66666667" width="6.66666667" height="6.66666667">
                                                            </rect>
                                                            <rect id="shape-copy-4" fill="#626870" x="0" y="0"
                                                                  width="6.66666667" height="6.66666667"></rect>
                                                            <rect id="shape-copy-6" fill="#626870" x="0" y="13.3333333"
                                                                  width="6.66666667" height="6.66666667"></rect>
                                                            <rect id="shape-copy-5" fill="#626870" x="13.3333333" y="0"
                                                                  width="6.66666667" height="6.66666667"></rect>
                                                            <rect id="shape-copy-7" fill="#626870" x="13.3333333"
                                                                  y="13.3333333" width="6.66666667" height="6.66666667">
                                                            </rect>
                                        ...
                                        <div class="editor__option__content">
                                            <div class="form__group form__group--inline-3">
                                                ...
                                                <input class="rangeInput" type="number" name="opacity_text"
                                                       id="textFormatOptionsOpacityText" value="100" min="0" max="100" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="editor__toolbar__option toolbar-tofront">
                                        <div class="editor__option tofront">
                                            <svg width="20px" height="20px" viewBox="0 0 20 20" version="1.1"
                                                 ...
                                                 xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <g transform="translate(-855.000000, -391.000000)" stroke="#161616"
                                                       stroke-width="2">
                                                        <g transform="translate(855.000000, 391.000000)">
                                                            <rect id="shape-copy-9" x="6.45454545" y="6.45454545"
                                                                  width="12.5454545" height="12.5454545" rx="1"></rect>
        ...
        <div id="process" class="process">
            <p id="processText" class="processAction title2">Adding page numbers...</p>
        ...
        <script>
            ...
            iloveLang.left = 'left';
            ilovepdfConfig.taskId = '1d2y033whtw0hvm770mrjblksrmdypyhgd3fvzv1mt4nk47l0nlf433mbx9gzddmvdzk32vh9rA9mzAgql8214t7ydddprqx0vf9t5ssgm5mhzc9cqjA9b3666zs3ywvbjAjnwypAng4Avbf87jp1pmn9qzfj2t74j9fzgdlcjnyt8pvpx5q';
        </script>
    ...
    <script>
        var siteData = {
            ...
            csrfToken: 'hAo0nv3QrxXV1RwmA8q64giKekA343Wh2jed-3Mak7TLXG7quamYIOGhMWpmvsy4P8AdFGayIOOfX9etI0rLww=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
    ...
    <script src="dist/js/pagenumber.01f5a37.js" async="async"></script>
@endsection
