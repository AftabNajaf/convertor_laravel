...
@section('title','Compress PDF online. Same PDF quality less file size')
@section('content')
    <div class="main">
        ...
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__header">
                    <h1 class="tool__header__title">Compress PDF files</h1>
                    <h2 class="tool__header__subtitle">Reduce file size while optimizing for maximal PDF quality.</h2>
                </div>
                ...
                <div id="ad" class="add">
                    <div id='div-gpt-ad-1662467548987-0' class="in_add">
                        <script>
                            googletag.cmd.push(function () { googletag.display('div-gpt-ad-1662467548987-0') });
                        </script>
                    </div>
                </div>
            ...
            <div id="sidebar" class="tool__sidebar">
                <div class="option__panel option__panel--active" id="compress-options">
                    <div class="option__panel__title">Compression level</div>
                    <div class="options">
                        <ul class="option__select" data-action="null">
                            <li class="option__select__item" data-name="compression_level" data-value="extreme">
                                <div class="option__select__item__title">
                                    Extreme Compression </div>
                                <div class="option__description">
                                    Less quality, high compression </div>
                            </li>
                            <li class="option__select__item" data-name="compression_level" data-value="recommended">
                                <div class="option__select__item__title">
                                    Recommended Compression </div>
                                <div class="option__description">
                                    Good quality, good compression </div>
                            </li>
                            <li class="option__select__item" data-name="compression_level" data-value="low">
                                <div class="option__select__item__title">
                                    Less compression </div>
                                <div class="option__description">
                                    High quality, less compression </div>
                            </li>
                        </ul>
                    </div>

                    <div class="gobutton">Click on COMPRESS PDF button</div>
                </div>
            </div>
        </div>
        ...
        <div id="process" class="process">
            <p id="processText" class="processAction title2">Compressing PDF...</p>
    ...
    <script>
        var siteData = {
            ...
            csrfToken: 'dxdu-8MeHyyLo1vpkc4S6lICoc0Y6iMzPYwMkwAfqmo4QTSPh2coGb_XdqX0umSwZUjGmUm7dnF45EbFUE_yHQ=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
