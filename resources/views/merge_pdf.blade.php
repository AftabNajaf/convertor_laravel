...
@section('title','Merge PDF files online. Free service to merge PDF')
@section('content')
    <div class="main">
        <div class="tool tool--small">
            <div class="tool__workarea" id="workArea">
                ...
                <div id="uploader" class="uploader">
                    <a
                        class="uploader__btn tooltip--left"
                        id="pickfiles"
                        href="javascript:;"
                    ...
                    <div class="uploader__extra">
                        <a
                            class="btn-icon uploader__extra__btn tooltip tooltip--right"
                            id="uploadDisk"
                            href="javascript:;"
                ...
                <div id="ad" class="add">
                    <div id="div-gpt-ad-1662466939918-0" class="in_add">
                        <script>
                            googletag.cmd.push(function () {
                                googletag.display("div-gpt-ad-1662466939918-0");
                            });
                        </script>
                    </div>
                </div>
                ...
                <div class="sidetools">
                    ...
                    <a
                        class="btn-icon btn-icon--white tooltip active tooltip--left order"
                        id="orderByName"
                        data-order="asc"
                        href="javascript:;"
                    ...
                    <a
                        class="btn-icon btn-icon--white tooltip active tooltip--left"
                        id="toggleCover"
                        href="javascript:;"
        ...
        <div id="uploading" class="uploading">
            <div id="upload-status" class="uploading__status">
                <div class="uploading__status__title drive">
                    <img src="img/svg_icons/preload.svg" alt="Uploading"/>Getting files
                    from Drive
                </div>
                ...
                <div class="uploading__status__title user">
                    Uploading file <span class="uploading__status__current">0</span> of
                    <span class="uploading__status__total">0</span>
                </div>
                <div class="uploading__status__file"></div>
                <div class="uploading__status__info">
                    Time left <span id="timeLeft">- seconds</span> - Upload speed
        ...
        <script>
            var iloveLang = {
                ...
                "Your file has been saved to Drive!":
                    "Your file has been saved to Drive!",
                Ok: "Ok",
                processCompleted:
                    "The task has been completed!<br> Going to download page...",
                ...
                FileRemoved:
                    "Some files you selected from your device seem to have been renamed, deleted or moved. Please, next time, wait until upload finishes.",
                ...
                errorRetry:
                    'It looks like a connection problem is stopping your files from being processed. We suggest that you wait a little while, then reload the page and try again.<br><br>If this doesn\'t work, you could try by disabling your web extensions or using the incognito browser. If the problem persists, please contact us.<br><br><a href="https://www.ilovepdf.com/\&quot;#"" onclick="location.reload();">Reload the page and try again</a>',
                "File number exceeded": "File number exceeded",
                "File size exceeded": "File size exceeded",
                "Sorry, we are not ready for that.":
                    "Sorry, we are not ready for that.",
                superlimitWhoa: "You've hit the limit, even for Premium. Whoa!",
                superlimitDownload:
                    "Unfortunately, our system doesn't have enough capacity to process your task. For now.",
                "Original size (in pixels) for this image":
                    "Original size (in pixels) for this image",
                "This image will be resized to this size (in pixels)":
                    "This image will be resized to this size (in pixels)",
                "Uploading...": "Uploading...",
                "1 file": "1 file",
                "1 mb": "1 mb",
                ...
                limitTaskMsg:
                    "This task is <strong>limited to ${currentLimit}</strong> for ${currentLevel}. <strong>${nextLevel} can upload up to ${nextLimit}</strong>. Some of your files have not been added.",
                ...
                featurePremium:
                    "This <strong>feature</strong> requires you to be <strong>Premium</strong>",
                "Premium feature": "Premium feature",
                "Welcome back after upload":
                    "We are glad you are here again. But for security reasons, your files aren't. To (toolname) your (fileformat), please get back to our homepage. ",
                ...
                previousFail:
                    "We are sorry. We couldn't load the previous task files.",
                previousFailContinue: "Ok",
                previousFailBack: "Back to download",
                disabledMultipleFiles:
                    "Option disabled because there are multiple files",
                registeredFeatureTitle: "Registered feature",
                registeredFeatureSubtitle:
                    "This <strong>feature</strong> requires you to be <strong>Registered user</strong>",
                authTitle: "iLovePDF Accounts",
                authSubtitle: "Get access to extended features",
                ProtectedFile: "Password protected file",
                limitMb:
                    "The file you are trying to process is bigger than ${mb} MB.",
                limitFiles: "You are trying to process more than ${files} files.",
                featureRequired:
                    "<strong>Feature</strong> available for <strong>Registered users</strong>",
                limitFree: "Free:",
            ...
            var premiumData = {
                ...
                priceMonth:
                    '<span class="pricing__price__numbers">6</span><span class="pricing__price__code">US</span>$',
                priceYear:
                    '<span class="pricing__price__numbers">48</span><span class="pricing__price__code">US</span>$',
                priceYearMonthly:
                    '<span class="pricing__price__numbers">4</span><span class="pricing__price__code">US</span>$',
            };
            var country = "PK";
            var ab = {limits: "b"};
        </script>
        <script>
            var ilovepdfConfig = {
                ...
                parentId: null,
                preWorker: null,
                defaultOptions: {level: null, output_filename: "ilovepdf_merged"},
                fileLimits: {
            ...
            ilovepdfConfig.taskId =
                "jy1vdhA8fn5j5lrw52wyrx6kcgcrm3y0j94lp3At29pm9rg65xdhnAgh7rcpfjr7ytcArjsvwAwvAnybclpmg0h05btlyptmA7rvv3w2sA2d2wAx9Az45l7034m5gt3bgAmm4sxrb7j1x9km6sv4chvp35dk3sctflblg54vfqn50Agh2481";
        </script>
    </div>
    <div class="footer">
    ...
    <script>
        var siteData = {
            ...
            csrfToken:
                "VwMheWfzRhqBBy3U7gFmi_X2DBI5wAnUSNAXl4qhVOMYVXsNI4pxL7VzAJiLdRDRwrxrRmiRXJYNuF3B2vEMlA==",
        };
        var lang = "en-US";
        var brand = "iLovePDF";
        ...
        var nds = {
            ck: 0,
            content:
                '<p>We hope you like it and find it easier to use.<br>If you run into any issues, please <a href="https://www.ilovepdf.com/\&quot;/contact\&quot;">let us know</a>.<br>We can fix any problem if we know about it.</p>',
            title:
                '<span style="color:#1D9D58">Welcome to the newly designed iLovePDF</span>',
        };
    </script>
    <script>
        var uCookie = {
