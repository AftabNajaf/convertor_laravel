...
@section('title','Convert Word to PDF. Documents DOC to PDF')
@section('content')
    <div class="main">
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__header">
                    <h1 class="tool__header__title">Convert WORD to PDF</h1>
                    <h2 class="tool__header__subtitle">Make DOC and DOCX files easy to read by converting them to PDF.</h2>
                </div>
                ...
                <div id="uploader" class="uploader" >
                    ...
                    <div class="uploader__extra">
                        ...
                        <a id="gdrive_file_selector"
                           ...
                           title="Select WORD from Google Drive">
                        ...
                        <a id="dropbox_file_selector"
                           class="btn-icon uploader__extra__btn tooltip tooltip--right active"
                           title="Select WORD from Dropbox">
                    ...
                    <div class="uploader__droptxt">or drop WORD documents here</div>
            ...
            <div id="sidebar" class="tool__sidebar">
                <div class="option__panel option__panel--active" id="merge-options">
                    <div class="option__panel__title">Word to PDF</div>
        ...
        <div id="uploading" class="uploading">
            ...
            <p id="processText" class="processAction title2">Converting WORD to PDF...</p>
    ...
    <script>
        var siteData = {
            ...
            csrfToken: 'DRVFuU_gneXvR9ddhV5qFqR5JCDu4fReJHS-WkN3jCVCQx_NC5mq0Nsz-hHgKhxMkzNDdL-woRxhHPQMEyfUUg=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
