...
@section('title','iLovePDF | Online PDF tools for PDF lovers')
@section('content')
    <div class="main">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <div class="home-title">
                        ...
                        <h2 class="subtitle">Every tool you need to use PDFs, at your fingertips. All are 100% FREE and easy to use!
                            Merge, split, compress, convert, rotate, unlock and watermark PDFs with just a few clicks.</h2>
                    </div>
                </div>
                <div class="item">
                    <div class="home-title">
        ...
        <div class="tools">
            <div class="tools__container">
                <div class="tools__item">
                    <a href="{{route('merge_pdf')}}" title="Merge PDF">
                ...
                <div class="tools__item">
                    <a href="{{route('split_pdf')}}" title="Split PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <g fill="rgb(93.333333%,42.352941%,30.196078%)" fill-rule="evenodd">
                                    <path
                ...
                <div class="tools__item">
                    <a href="compress_pdf.html" title="Compress PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <path
                ...
                <div class="tools__item">
                    <a href="pdf_to_word.html" title="PDF to Word">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <path
                        ...
                        <h3>PDF to Word</h3>
                        <div class="tools__item__content">
                            <p>Easily convert your PDF files into easy to edit DOC and DOCX documents. The converted
                                WORD
                                document is almost 100% accurate.</p>
                        </div>
                    </a>
                </div>
                <div class="tools__item">
                    <a href="pdf_to_powerpoint.html" title="PDF to Powerpoint">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <path
                ...
                <div class="tools__item">
                    <a href="pdf_to_excel.html" title="PDF to Excel">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <path
                                    d="M32.324 15.656h-9.55c-2.477 0-3.375.258-4.28.742a5.06 5.06 0 0 0-2.098 2.102c-.484.902-.742 1.8-.742 4.277v9.55H5.18c-1.8 0-2.453-.187-3.113-.54a3.69 3.69 0 0 1-1.527-1.527C.188 29.598 0 28.945 0 27.145V5.18c0-1.8.188-2.453.54-3.113A3.69 3.69 0 0 1 2.066.539C2.727.188 3.38 0 5.18 0h21.965c1.8 0 2.453.188 3.113.54a3.69 3.69 0 0 1 1.527 1.527c.352.66.54 1.313.54 3.113zm0 0"
                ...
                <div class="tools__item">
                    <a href="word_to_pdf.html" title="Word to PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <path
                ...
                <div class="tools__item">
                    <a href="powerpoint_to_pdf.html" title="Powerpoint to PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <path
                ...
                <div class="tools__item">
                    <a href="excel_to_pdf.html" title="Excel to PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <path
                                    d="M17.676 34.344h9.55c2.477 0 3.375-.258 4.28-.742a5.04 5.04 0 0 0 2.098-2.102c.484-.902.742-1.8.742-4.277v-9.547H44.82c1.8 0 2.453.188 3.113.54s1.176.87 1.527 1.527.54 1.31.54 3.113V44.82c0 1.8-.187 2.453-.54 3.113a3.69 3.69 0 0 1-1.527 1.527c-.66.352-1.312.54-3.113.54H22.855c-1.8 0-2.453-.187-3.113-.54s-1.172-.87-1.527-1.527-.54-1.312-.54-3.113zm0 0"
                ...
                <div class="tools__item">
                    <a href="edit-pdf.html" title="Edit PDF">
                        <div class="tools__item__icon">
                        ...
                        <h3>Edit PDF</h3>
                        <div class="tools__item__content">
                            <p>Add text, images, shapes or freehand annotations to a PDF document. Edit the size, font,
                                and
                                color of the added content.</p>
                        </div>
                    </a>
                </div>
                <div class="tools__item">
                    <a href="pdf_to_jpg.html" title="PDF to JPG">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <path
                                    d="M32.324 15.656h-9.55c-2.477 0-3.375.258-4.28.742a5.06 5.06 0 0 0-2.098 2.102c-.484.902-.742 1.8-.742 4.277v9.55H5.18c-1.8 0-2.453-.187-3.113-.54a3.69 3.69 0 0 1-1.527-1.527C.188 29.598 0 28.945 0 27.145V5.18c0-1.8.188-2.453.54-3.113A3.69 3.69 0 0 1 2.066.539C2.727.188 3.38 0 5.18 0h21.965c1.8 0 2.453.188 3.113.54a3.69 3.69 0 0 1 1.527 1.527c.352.66.54 1.313.54 3.113zm0 0"
                ...
                <div class="tools__item">
                    <a href="jpg_to_pdf.html" title="JPG to PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <path
                                    d="M17.676 34.344h9.55c2.477 0 3.375-.258 4.28-.742a5.04 5.04 0 0 0 2.098-2.102c.484-.902.742-1.8.742-4.277v-9.547H44.82c1.8 0 2.453.188 3.113.54s1.176.87 1.527 1.527.54 1.31.54 3.113V44.82c0 1.8-.187 2.453-.54 3.113a3.69 3.69 0 0 1-1.527 1.527c-.66.352-1.312.54-3.113.54H22.855c-1.8 0-2.453-.187-3.113-.54s-1.172-.87-1.527-1.527-.54-1.312-.54-3.113zm0 0"
                ...
                <div class="tools__item">
                    <a href="sign-pdf.html" title="Sign PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" height="50" width="50" viewBox="0 0 100 100">
                                <g fill="none">
                                    ...
                                    <path
                                        d="M16 0L84 0C89.5 0 91.6 0.6 93.6 1.7 95.6 2.8 97.2 4.4 98.3 6.4 99.4 8.4 100 10.5 100 16L100 84C100 89.5 99.4 91.6 98.3 93.6 97.2 95.6 95.6 97.2 93.6 98.3 91.6 99.4 89.5 100 84 100L16 100C10.5 100 8.4 99.4 6.4 98.3 4.4 97.2 2.8 95.6 1.7 93.6 0.6 91.6 0 89.5 0 84L0 16C0 10.5 0.6 8.4 1.7 6.4 2.8 4.4 4.4 2.8 6.4 1.7 8.4 0.6 10.5 0 16 0Z"
                                        fill="#4A7AAB"/>
                                    <g transform="translate(-371 -2828)translate(371 2828)translate(50.5 50.5)rotate(30)"
                                       fill="#FFF">
                                        <path
                ...
                <div class="tools__item">
                    <a href="pdf_add_watermark.html" title="Watermark">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <path
                ...
                <div class="tools__item">
                    <a href="rotate_pdf.html" title="Rotate PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50"
                                 fill-rule="evenodd">
                                <path
                ...
                <div class="tools__item">
                    <a href="html-to-pdf.html" title="HTML to PDF">
                        <div class="tools__item__icon">
                        ...
                        <h3>HTML to PDF</h3>
                        <div class="tools__item__content">
                            <p>Convert webpages in HTML to PDF. Copy and paste the URL of the page you want and convert
                                it
                                to PDF with a click.</p>
                        </div>
                    </a>
                </div>
                <div class="tools__item">
                    <a href="unlock_pdf.html" title="Unlock PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 100 100"
                                 fill-rule="evenodd">
                                <path
                ...
                <div class="tools__item">
                    <a href="protect-pdf.html" title="Protect PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 100 100">
                                <path
                                    d="M16.024 0h67.95c5.572 0 7.593.58 9.63 1.67s3.636 2.688 4.725 4.725 1.67 4.058 1.67 9.63v67.95c0 5.572-.58 7.593-1.67 9.63s-2.688 3.636-4.725 4.725-4.058 1.67-9.63 1.67h-67.95c-5.572 0-7.593-.58-9.63-1.67S2.76 95.642 1.67 93.605 0 89.548 0 83.976v-67.95c0-5.572.58-7.593 1.67-9.63S4.358 2.76 6.395 1.67 10.452 0 16.024 0z"
                        ...
                        <h3>Protect PDF</h3>
                        <div class="tools__item__content">
                            <p>Protect PDF files with a password. Encrypt PDF documents to prevent unauthorized
                                access. </p>
                        </div>
                    </a>
                </div>
                <div class="tools__item">
                    <a href="organize-pdf.html" title="Organize PDF">
                        <div class="tools__item__icon">
                        ...
                        <h3>Organize PDF</h3>
                        <div class="tools__item__content">
                            <p>Sort pages of your PDF file however you like. Delete PDF pages or add PDF pages to your
                                document at your convenience.</p>
                        </div>
                    </a>
                </div>
                <div class="tools__item">
                    <a href="convert-pdf-to-pdfa.html" title="PDF to PDF/A">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 100 100"
                                 fill-rule="evenodd">
                                <path
                        ...
                        <h3>PDF to PDF/A</h3>
                        <div class="tools__item__content">
                            <p>Transform your PDF to PDF/A, the ISO-standardized version of PDF for long-term archiving.
                                Your PDF will preserve formatting when accessed in the future.</p>
                        </div>
                    </a>
                </div>
                <div class="tools__item">
                    <a href="repair-pdf.html" title="Repair PDF">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50"
                                 fill-rule="evenodd">
                                <path
                        ...
                        <h3>Repair PDF</h3>
                        <div class="tools__item__content">
                            <p>Repair a damaged PDF and recover data from corrupt PDF. Fix PDF files with our Repair
                                tool.</p>
                        </div>
                    </a>
                </div>
                <div class="tools__item">
                    <a href="add_pdf_page_number.html" title="Page numbers">
                        <div class="tools__item__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50"
                                 fill-rule="evenodd">
                                <path
                ...
                <div class="tools__item">
                    <a href="scan-pdf.html" title="Scan to PDF">
                        <div class="tools__item__icon">
                        ...
                        <h3>Scan to PDF</h3>
                        <div class="tools__item__content">
                            <p>Capture document scans from your mobile device and send them instantly to your
                                browser.</p>
                        </div>
                    </a>
                </div>
                <div class="tools__item">
                    ...
                    <a href="ocr-pdf.html" title="OCR PDF">
                        <div class="tools__item__icon">
                            <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                      ...
                                      fill="#8FBC5D"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 40.5v-18H14v18h-1.5Z"
                                      fill="#fff"/>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 37.5v-12H14v12h-1.5Z"
                                      fill="#8FBC5D"/>
                                <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div class="block block--white">
            <div class="block__container">
                ...
                <div id="homepage-products-block" class="row">
                    <div id="homepage-products-block__moving-element"
                         class="col-lg-5 sticky-bulb__moving-element d-md-none d-lg-block">
                        <div id="homepage-products-block__moving-element_c">
                            ...
                            <div class=" carousel-inner">
                                <div class="carousel-item active" data-menu-idx="1">
                                    <img class="d-none d-lg-block" src="img/homepage-product-1.png" alt="First slide">
                                </div>
                                <div class="carousel-item" data-menu-idx="2">
                                    <img class="d-none d-lg-block" src="img/homepage-product-2.png" alt="Second slide">
                                </div>
                                <div class="carousel-item" data-menu-idx="3">
                                    <img class="d-none d-lg-block" src="img/homepage-product-3.png" alt="Third slide">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="homepage-products-block__sticky-element"
                     class="col-lg-6 col-md-12 sticky-bulb__sticky-element">
                    <div class="title1" skip-sticky-bulb>Looking for another solution?</div>
                    <div class="sticky-bulb__lightable-item" data-menu-idx="3">
                        <div class="title3">iLoveIMG</div>
                        <div><a href="#">iLoveIMG</a> is the web app that helps you modify images
                            in
                            bulk for free. Crop, resize, compress, convert, and more. All the tools you need to enhance
                            your
                            images in just a few clicks.
                        </div>
                        <img class="d-lg-none" src="img/homepage-product-3.png">
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class="block block--grey-admin">
        <div class="block__container">
            <div class="block__header">
                <div class="title1 text-center">The PDF software trusted by millions of users</div>
                <div class="subtitle text-center">iLovePDF is your number 1 web app for editing PDF with ease. Enjoy all
                    the
                    tools you need to work efficiently with your digital documents while keeping your data safe and
                    secure.
                </div>
            ...
            <div class="block__body">
                <div class="new-premium__logos ">
                    <img width="55px" height="25px" style="margin-top: 1px;" src="img/logos/pdf-association-logo.svg"
                         alt="PDF Association">
                    <img width="67px" height="30px" src="img/logos/iso-logo.svg" alt="ISO27001 certified">
                    <img width="89px" height="30px" src="img/logos/ssl-encrypted-logo.svg"
    ...
    <div class="block block--black">
        <div class="block__container section">
            <div class="row align-items-center d-lg-flex">
                <div class="col-lg-7 col-md-12 section__item">
                    <div class="title1">Get more with Premium</div>
                    <div class="subtitle">
                ...
                <div class="col-lg-5 col-md-12 d-flex justify-content-lg-end section__item">
                    <a href="user/premium.html" class="btn btn--orange btn--lg">Get Premium</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer>
        <div class="row">
            <div class="col-12">
                <img src="img/app-icon.png" class="logo">
