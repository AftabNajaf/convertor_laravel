...
@section('title','Repair PDF files online. Free tool to repair PDF')
@section('content')
    <div class="main">
        ...
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__header">
                    ...
                    <h2 class="tool__header__subtitle">Upload a corrupt PDF and we will try to fix it. Depending on how
                        much the PDF is damaged we will be able to recover it partially or completely.</h2>
                </div>
                ...
                <div id="ad" class="add">
                    <div id='div-gpt-ad-1662466375991-0' class="in_add">
                        <script>
                            googletag.cmd.push(function () { googletag.display('div-gpt-ad-1662466375991-0') });
                        </script>
                    </div>
                </div>
        ...
        <script>
            ...
            ilovepdfConfig.taskId = '1d70svrptAAf1f0kh98mjAdptj46fwxb7xjhnfm1n9l3vw4nA30ys3bwy6n7xwvbf81y6bglxbh78fnh6j433764sAl7gc0q49hnAfh2q89gv2rqgt5nfkzqrzch8zgbA9fjcvrA951d05t0tqksbz0zvh6bnkxk8whf29rlskwd41qxzv9q';
    ...
    <script>
        var siteData = {
            ...
            csrfToken: 'HfexoSzowFzqze_0AA6kytkzFLAAyXC9JKQnChg3IFhSoevVaJH3ad65wrhletKQ7nlz5FGYJf9hzG1cSGd4Lw=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
