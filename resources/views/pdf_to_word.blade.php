...
@section('title','PDF to WORD | Convert PDF to Word online for free')
@section('content')
    <div class="main">
        ...
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__wrapper">
                    <div class="tool__header">
                        <h1 class="tool__header__title">PDF to WORD Converter</h1>
                        <h2 class="tool__header__subtitle">Convert your PDF to WORD documents with incredible
                            accuracy.<br /> Powered by <a href="https://solidframework.net#solidframework"
                                                          rel="nofollow" target="_blank">Solid Documents</a>.</h2>
                    </div>
                    <div class="uploading__bar uploading__bar--small">
                        <span class="uploading__bar__completed"></span>
                    </div>
                    <div id="uploader" class="uploader">
                        <a class="uploader__btn tooltip--left" id="pickfiles" href="javascript:;"
            ...
            <div id="sidebar" class="tool__sidebar">
                <div class="option__panel option__panel--active" id="merge-options">
                    <div class="option__panel__title">PDF to Word</div>
                        ...
                        <ul class="option__select" data-action="null">
                            <li class="option__select__item option--active" data-name="ocr" data-value="0">
                                ...
                                <div class="option__description">
                                    Converts PDFs with selectable text to editable Word files. </div>
                            </li>
                            <li class="option__select__item" data-name="ocr" data-value="1"
                                ...
                                <div class="option__description">
                                    Converts scanned PDFs with non-selectable text to editable Word files. </div>
                            </li>
                        </ul>
                    </div>
                    <input type="hidden" name="convert_to" value="docx" class="option">
        ...
        <div id="process" class="process">
            <p id="processText" class="processAction title2">Converting PDF to WORD...</p>
    ...
    <script>
        var siteData = {
            ...
            csrfToken: '3kw9ef8L9b5eLhmNf0CNtPk7N7gSIkPggx_1vOpMHMiRGmcNu3LCi2paNMEaNPvuznFQ7ENzFqLGd7_quhxEvw=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
