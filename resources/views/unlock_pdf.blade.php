...
@section('title','Unlock PDF files. Remove PDF password')
@section('content')
    ...
    <div class="main">
        ...
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__header">
                    <h1 class="tool__header__title">Unlock PDF</h1>
                    <h2 class="tool__header__subtitle">Remove PDF password security, giving you the freedom to use your
                        PDFs as you want.</h2>
                </div>
                ...
                <div id="ad" class="add">
                    <div id='div-gpt-ad-1662466210631-0' class="in_add">
                        <script>
                            googletag.cmd.push(function () { googletag.display('div-gpt-ad-1662466210631-0') });
                        </script>
                    </div>
                </div>
            ...
            <div id="sidebar" class="tool__sidebar">
                <div class="option__panel option__panel--active" id="merge-options">
                    <div class="option__panel__title">Unlock PDF</div>
                    <div class="option__panel__content">
                        <div class="info">Just press the unlock button.</div>
                        <div class="gobutton">Click on UNLOCK PDF button</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="process" class="process">
            <p id="processText" class="processAction title2">Unlocking PDF...</p>
    ...
    <script>
        var siteData = {
            ...
            csrfToken: 'YUFz0Ts135gUU7wIwWOgiFrqapEXJOmC3wgYSDeih0EuFymlf0zorSAnkUSkF9bSbaANxUZ1vMCaYFIeZ_LfNg=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
