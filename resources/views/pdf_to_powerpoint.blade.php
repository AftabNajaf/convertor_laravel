...
@section('title','Convert PDF to Powerpoint. PDF to PPT slides online')
@section('content')
    <div class="main">
        ...
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__wrapper">
                    <div class="tool__header">
                        <h1 class="tool__header__title">Convert PDF to POWERPOINT</h1>
                        <h2 class="tool__header__subtitle">Convert your PDFs to POWERPOINT.<br /> Powered by <a
            ...
            <div id="sidebar" class="tool__sidebar">
                <div class="option__panel option__panel--active" id="merge-options">
                    <div class="option__panel__title">PDF to Powerpoint</div>
                    <input type="hidden" name="convert_to" value="pptx" class="option">
        ...
        <div id="process" class="process">
            <p id="processText" class="processAction title2">Converting PDF to POWERPOINT...</p>
    ...
    <script>
        var siteData = {
            ...
            csrfToken: 'GZwQ_yefikFgNsWa8MvSZoGTgnBHokN2QXlewRxjl5tWykqLY-a9dFRC6NaVv6Q8ttnlJBbzFjQEERSXTDPP7A=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
