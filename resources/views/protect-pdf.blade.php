...
@section('title','Protect PDF. Tool to encrypt PDF with password')
@section('content')
    <div class="main">
        ...
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__header">
                    ...
                    <h2 class="tool__header__subtitle">Encrypt your PDF with a password to keep sensitive data
                        confidential.</h2>
                </div>
                ...
                <div id="ad" class="add">
                    <div id='div-gpt-ad-1662466478941-0' class="in_add">
                        <script>
                            googletag.cmd.push(function () { googletag.display('div-gpt-ad-1662466478941-0') });
                        </script>
                    </div>
                </div>
            ...
            <div id="sidebar" class="tool__sidebar">
                <div class="option__panel option__panel--active" id="merge-options">
                    <div class="option__panel__title">Protect PDF</div>
                    <div class="option__panel__content">
                        <p class="option__title">Set a password to protect your PDF file</p>
                        <div class="form__group form__group--btn form__group--btn-lg">
                            <div class="input--icon input--lock">
                                <input id="pwd" class="input option" type="password" name="password" tabindex="1"
                                       autocomplete="protect-pdf" placeholder="Type a password">
                            </div>
                            <a class="btn showPassword" href="protect-pdf.html#">
                        ...
                        <div class="form__group form__group--btn form__group--btn-lg">
                            <div class="input--icon input--lock">
                                <input id="pwd2" class="input option" type="password" name="password2" tabindex="2"
                                       autocomplete="protect-pdf-repeat" placeholder="Repeat password">
                            </div>
                            <a class="btn  showPassword" href="protect-pdf.html#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path
                    ...
                    <div class="option__panel__content">
                        <br>
                        <div class="alert alert--warning hidden" id="passwordsNotMatch">Passwords do not match.</div>
                    </div>
                    <div class="gobutton">Click on PROTECT PDF button</div>
                </div>
            </div>
        </div>
        ...
        <div id="process" class="process">
            <p id="processText" class="processAction title2">Adding password to PDF...</p>
    ...
    <script>
        var siteData = {
            ...
            csrfToken: 'oIhRpnCSY8UIoG4Tihc_0y40bZs-isVz3QtV8Q7UPW3v3gvSNOtU8DzUQ1_vY0mJGX4Kz2_bkDGYYx-nXoRlGg=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
