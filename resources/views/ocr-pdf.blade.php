...
@section('title','Make PDF searchable. Online OCR tool.')
@section('content')
    ...
    <div class="main">
        ...
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__header">
                    <h1 class="tool__header__title">OCR PDF</h1>
                    <h2 class="tool__header__subtitle">Convert non-selectable PDF files into selectable and searchable
                        PDF with high accuracy.</h2>
                </div>
            ...
            <div id="sidebar" class="tool__sidebar">
                <div class="option__panel option__panel--active" id="pdfocr-options">
                    <div class="option__panel__title">OCR PDF options</div>
                    <div class="options">
                        <div class="option__panel__content">
                            <div class="info multiple">The accuracy of detection is increased by correctly selecting the
                                document's languages.</div>
                            <div class="form__group">
                                <div class="float-right" multiselect-select-limit-status></div>
                                <div class="option__title">Document languages</div>
                            </div>
                            <select name="ocr_languages" id="languagesOcr" multiple multiselect-search="true"
                                    multiselect-select-all="false" multiselect-max-items="3">
                ...
                <script>
                    var multiselectDropdownOptions = {
                        sort: true,
        ...
        <div id="process" class="process">
            <p id="processText" class="processAction title2">Recognising text...</p>
    ...
    <script>
        var siteData = {
            ...
            csrfToken: 'k5bNRBkN0DQj1aaaQ-Q5y0AygnYauyGCtZjltXrXaKvcwJcwXXTnARehi9YmkE-Rd3jlIkvqdMDw8K_jKocw3A=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
    ...
    <script src="dist/js/pdfocr.01f5a37.js" async="async"></script>
@endsection
