...
@section('title','Remove pages from a PDF online')
@section('content')
    <div class="main">
        ...
        <div class="tool">
            <div class="tool__workarea" id="workArea">
                ...
                <div class="tool__header">
                    <h1 class="tool__header__title">Remove PDF pages</h1>
                    <h2 class="tool__header__subtitle">Select and remove the PDF pages you don’t need. Get a new file without your deleted pages.</h2>
                </div>
                ...
                <div id="uploader" class="uploader" >
                    ...
                    <div id='div-gpt-ad-1662466259704-0' class="in_add">
                        <script>
                            googletag.cmd.push(function() { googletag.display('div-gpt-ad-1662466259704-0') });
                        </script>
                    </div>
                </div>
                ...
                <div class="tool__workarea__rendered" id="split-remove"></div>
            </div>
            <div id="sidebar" class="tool__sidebar">
                <div class="option__panel option__panel--active" id="remove">
                    <div class="option__panel__title">Remove pages</div>
                    <div class="option__panel__content">
                        <div
                            class="info">Click on pages to remove from document. You can use "shift" key to set ranges.        </div>
                        <p>Total pages: <span class="numPages"></span></p>
                        <div class="form__group">
                            <label>Pages to remove:</label>
                            <input type="text" name="remove_pages" id="remove_pages" placeholder="example: 1,5-8">
                        </div>


                        <input class="option" type="hidden" name="split_mode" value="remove_pages">
                        <input class="option" type="hidden" name="merge_after" value="false">

                        <div class="gobutton">Click on SPLIT PDF button</div>
                    </div>
                </div>    </div>
        </div>
        ...
        <div id="uploading" class="uploading">
            ...
            <p id="processText" class="processAction title2">Removing PDF pages...</p>
    ...
    <script>
        var siteData = {
            ...
            csrfToken: '8mP3VMJW8DSp3_C7tVXGM5rRYktYdsSChJZ4ehCjfxm9Na0ghi_HAZ2r3ffQIbBprZsFHwknkcDB_jIsQPMnbg=='
        };
        var lang = 'en-US';
        var brand = 'iLovePDF';
